...
// resident packet (2024 packet, retrieved from the Internet Archive because oklahoma.gov serves
// only the current year at .../individuals/current/511-Pkt.pdf: https://web.archive.org/web/20250507103247/https://oklahoma.gov/content/dam/ok/en/tax/documents/forms/individuals/current/511-Pkt.pdf).
//
...
//   Married joint / head of household, packet says $4,373:
//     2000x0.25% + 3000x0.75% + 2500x1.75% + 2300x2.75% + 4600x3.75%
//       = $307.00 at $14,400, then 85,600x4.75% = $4,066.00 -> $4,373.00
//   The joint top boundary moved from $12,200 (2023) to $14,400 here, and
//   only $14,400 reproduces the $4,373 printed in this packet.
//
...
// at $100,000 it owes $4,562, not half of $4,373.
export default {
  [STANDARD_DEDUCTION]: {
    [SINGLE]: 6350,
    [MARRIED]: 12700,
