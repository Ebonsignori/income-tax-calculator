...
export default {
  ...
  //
  // Source: 2025 Form 40 booklet, "Standard Deduction" chart, p.8, with the
  ...
  [CITIES]: {
    ...
    // MID-YEAR CHANGE, not modelled: 1.5% through 2025-03-31, 1% from
    // 2025-04-01. This file carries the POST-change 1%, which covers three of
    // the four quarters. Verified 2026-09-07 from the city's own quarterly
    // return: line 5 computes "Total Due for Quarter at 1% (Line 4 x .01)",
    // footnoted "As of April 1, 2025, the City of Opelika reduced the
    // withholding fee from 1.5% to 1%".
