...
export default {
  ...
  // "Tax Registers (Official)", historic report, reporting period 2025.
  // Four of the fourteen were wrong; all four are corrected below.
  [CITIES]: {
    // Corrected 2026-09-07: 3.74% -> 3.75%.
    //
    ...
    // the calendar year. For 2025 that is 3.75%, set on 2023-07-01 and held
    // through 2025-06-30; the rate fell to 3.74% on 2025-07-01. The file
    // carried the post-change 3.74%, which is the opposite of what 2023, 2024
    // and 2026 do.
    ...
    // Verified 2026-09-07: 1.1% city (raised from 0.6% on 2025-01-01) + 0.5%
    // Lancaster S D = 1.6%. 2025 is the first year at 1.6%.
    [LANCASTER]: {
      [CITY_INCOME]: {
    ...
    // Corrected 2026-09-07: 1.2% -> 1.7%. Register: 1.2% city (raised from
    // 1.1% on 2025-01-01) + 0.5% Altoona Area S D = 1.7%. The city rate alone
    // was stored; the school district rate was missing.
    [ALTOONA]: {
      [CITY_INCOME]: {
