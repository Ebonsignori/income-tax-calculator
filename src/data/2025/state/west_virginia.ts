...
export default {
  // Every rate is 6% below its 2024 value (2.36 x 0.94 = 2.22, and so on),
  // the first reduction after the HB 2526 (2023) schedule.
  // Verified against the 2025 Tax Rate Schedules, page 35 of the Personal
  // Income Tax Information and Instructions. The cumulative amounts
  // reconcile: $222.00 = 2.22% x $10,000; $666.00 = $222 + 2.96% x $15,000;
  // $1,165.50 = $666 + 3.33% x $15,000; $2,053.50 = $1,165.50 + 4.44% x
  // $20,000.
  // https://tax.wv.gov/Documents/PIT/2025/it140.TaxRateSchedules.2025.pdf
  [STATE_INCOME]: {
    [SINGLE]: [
      { min: 0, max: 10000, rate: 2.22 },
      { min: 10000, max: 25000, rate: 2.96 },
      { min: 25000, max: 40000, rate: 3.33 },
    ...
    [MARRIED_SEPARATELY]: [
      { min: 0, max: 5000, rate: 2.22 },
      { min: 5000, max: 12500, rate: 2.96 },
      { min: 12500, max: 20000, rate: 3.33 },
      { min: 20000, max: 30000, rate: 4.44 },
      { min: 30000, max: INFINITY, rate: 4.82 },
    ],
    [HEAD_OF_HOUSEHOLD]: [
      { min: 0, max: 10000, rate: 2.22 },
      { min: 10000, max: 25000, rate: 2.96 },
