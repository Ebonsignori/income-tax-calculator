...
export default {
  ...
  [NY_PAID_FAMILY_LEAVE]: {
    [SINGLE]: [{ min: 0, max: 91400, rate: 0.388 }],
    [MARRIED]: [{ min: 0, max: 91400, rate: 0.388 }],
    [MARRIED_SEPARATELY]: [{ min: 0, max: 91400, rate: 0.388 }],
    [HEAD_OF_HOUSEHOLD]: [{ min: 0, max: 91400, rate: 0.388 }],
  },
  [NY_DISABILITY_INSURANCE]: {
