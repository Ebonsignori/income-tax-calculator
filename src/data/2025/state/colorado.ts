...
export default {
  ...
  // Back to 4.40% after 2024's one-year cut to 4.25%. SB 24-228 re-arms the
  // temporary reduction each year through 2035, but only if the TABOR surplus
  // clears $300M; the FY2024-25 surplus came in at ~$297M, so it did not
  // trigger. (SB 25-138 would have made 4.25% permanent and was postponed
  // indefinitely.) Confirmed by the DOR's own 2025 DR 0104 booklet: "The income
  // tax rate is currently 4.4%."
