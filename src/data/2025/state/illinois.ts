...
export default {
  ...
  // Source: 2025 Form IL-1040 Instructions, "Illinois Income Tax rate"
  ...
  //
  // $2,850 per exemption for 2025. A joint return claims two (the filer and
  ...
  //
  // Source: 2025 Form IL-1040 Instructions, Step 4 line 10a chart and the
  // "Income Exceptions" box.
  [STANDARD_DEDUCTION]: {
    [SINGLE]: [
      { min: 0, max: 250001, amount: 2850 },
      { min: 250001, max: INFINITY, amount: 0 },
    ],
    [MARRIED]: [
      { min: 0, max: 500001, amount: 5700 },
