...
export default {
  ...
  [STATE_INCOME]: {
    [SINGLE]: [
      ...
      { min: 11000, max: 16000, rate: 4.3 },
      { min: 16000, max: 100000, rate: 4.7 },
      { min: 100000, max: 210000, rate: 4.9 },
      { min: 210000, max: INFINITY, rate: 5.9 },
    ],
    [MARRIED]: [
      { min: 0, max: 8000, rate: 1.5 },
      { min: 8000, max: 16000, rate: 3.2 },
      { min: 16000, max: 24000, rate: 4.3 },
      { min: 24000, max: 150000, rate: 4.7 },
      { min: 150000, max: 315000, rate: 4.9 },
      { min: 315000, max: INFINITY, rate: 5.9 },
    ],
    [MARRIED_SEPARATELY]: [
      { min: 0, max: 4000, rate: 1.5 },
      { min: 4000, max: 8000, rate: 3.2 },
      { min: 8000, max: 12000, rate: 4.3 },
      { min: 12000, max: 75000, rate: 4.7 },
      { min: 75000, max: 157500, rate: 4.9 },
