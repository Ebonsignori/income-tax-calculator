...
export default {
  ...
  //
  // Source: 2023 Form 40 booklet, "Standard Deduction" chart, p.8, with the
  ...
  // https://www.revenue.alabama.gov/wp-content/uploads/2024/01/23f40bk.pdf
  ...
  [CITIES]: {
    ...
    // Verified 2026-09-07: 0.75%. The city publishes its own fee history: 1%
    // from 2018-08-01 (Ordinance 2018-10c), reduced "first on July 19, 2022
    // (Ordinance 2022-14 reducing to .75%) and again on July 2, 2024
    // (Ordinance 2024-12 reducing to .50%)".
