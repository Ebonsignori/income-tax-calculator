...
export default {
  ...
  // DFS's 2023 premium rate decision: 0.455% of wages up to the annualized
  // NYSAWW of $87,785.88 (52 x $1,688.19), for a maximum contribution of
  // $399.43. `max` has to be an integer, and 87786 is the one that lands on
  // $399.43 exactly -- 87785 comes to $399.42, so do not "round" it down.
  [NY_PAID_FAMILY_LEAVE]: {
    [SINGLE]: [{ min: 0, max: 87786, rate: 0.455 }],
    [MARRIED]: [{ min: 0, max: 87786, rate: 0.455 }],
    [MARRIED_SEPARATELY]: [{ min: 0, max: 87786, rate: 0.455 }],
    [HEAD_OF_HOUSEHOLD]: [{ min: 0, max: 87786, rate: 0.455 }],
  },
  ...
  // assumed.
  //     https://www.tax.ny.gov/forms/html-instructions/2023/it/it201i-2023.htm
  [CITIES]: {
    [NEW_YORK_CITY]: {
      [NYC_INCOME]: {
        [SINGLE]: [
    ...
    [YONKERS]: {
      ...
      //
      // Source: 2023 Form IT-201-I, "Line 55: Yonkers resident income tax
