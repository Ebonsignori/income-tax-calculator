...
export default {
  ...
  // Source: 2023 Form IL-1040 Instructions, "Illinois Income Tax rate"
  // and "Exemption Allowance" (Public Act 103-0009).
  // https://tax.illinois.gov/content/dam/soi/en/web/tax/forms/incometax/documents/2023/individual/il-1040-instr.pdf
  ...
  //
  // $2,425 per exemption for 2023. A joint return claims two (the filer and
  ...
  //
  // Source: 2023 Form IL-1040 Instructions, Step 4 line 10a chart and the
  // "Income Exceptions" box.
  [STANDARD_DEDUCTION]: {
    [SINGLE]: [
      { min: 0, max: 250001, amount: 2425 },
      { min: 250001, max: INFINITY, amount: 0 },
    ],
    [MARRIED]: [
      { min: 0, max: 500001, amount: 4850 },
