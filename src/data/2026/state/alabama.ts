...
export default {
  ...
  //
  // Source: the 2026 Form 40 booklet is not published yet, so this is ADOR's
  // January 2026 withholding booklet, which prints both the four charts
  // ("Schedule of Standard Deduction Amounts", p.7) and the formula quoted
  // above ("Formula For Computing Alabama Withholding Tax", p.6). Both are
  // unchanged from the 2023, 2024 and 2025 Form 40 booklets.
  ...
  [CITIES]: {
    ...
    // Verified 2026-09-07: 0.50%, effective 2024-07-02 under Ordinance
    // 2024-12, the second of two cuts from the original 1%.
    ...
    // Verified 2026-09-07: 1%, effective 2025-04-01 (down from 1.5%). The
    // city's quarterly return computes "Total Due for Quarter at 1% (Line 4 x
    // .01)". Note the League's roster still shows the old 1.5%.
